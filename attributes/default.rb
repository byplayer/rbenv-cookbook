...
default[:rbenv][:git_repository] = 'https://github.com/rbenv/rbenv.git'
...
default[:ruby_build][:git_repository] = 'https://github.com/rbenv/ruby-build.git'
default[:ruby_build][:git_revision]   = 'master'

default[:rbenv_vars][:git_repository] = 'https://github.com/rbenv/rbenv-vars.git'
